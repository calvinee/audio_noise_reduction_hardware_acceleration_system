...
#
# fir_reload.tcl: Tcl script for re-creating project 'fir_reload'
#
# Generated by Vivado on Thu May 05 18:01:37 +0800 2022
...
#
# 1. This project restoration tcl script (fir_reload.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/runproject/KEHU/fir_lab/FIR_LAB_N_V2/FIR_LAB_NEW/fir_reload/fir_reload.srcs/sources_1/bd/design_1/design_1.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  ...
  set paths [list \
   [file normalize "$origin_dir/../../../../../UnderwaterModem/Updated_MyXilinx/ip_repo"] \
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "fir_reload"
...
set script_file "fir_reload.tcl"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../../V2020_Xilinx/Vivado/2020.2/data/boards"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../../UnderwaterModem/Updated_MyXilinx/ip_repo"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/fir_reload.srcs/sources_1/bd/design_1/design_1.bd" ]\
]
set imported_files [import_files -fileset sources_1 $files]

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/fir_reload.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "C:/home/jared/Projects/Pynq-Z2/overlays/fir_reload_overlay/fir_reload/fir_reload.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "C:/home/jared/Projects/Pynq-Z2/overlays/fir_reload_overlay/fir_reload/fir_reload.srcs/utils_1/imports/impl_1" -objects $obj
